<?php foreach ($todoTasks as $todoTask) { ?>
   ...
   <div id="task" class="task relative flex flex-col items-start p-1 mt-3 bg-white rounded-lg cursor-pointer bg-opacity-90 group hover:bg-opacity-100 " draggable="true">
      ...
      <span class="flex items-center h-6 px-2 text-xs font-semibold text-pink-500 bg-pink-100 rounded-full"><?php echo $todoTask['type'] ?></span>
      <h4 class=" text-sm font-medium"><?php echo $todoTask['titre'] ?></h4>
      <div class="flex w-full items-center ">
         ...
         <a href="controllers/changeStatut.php?id=<?php echo $todoTask['id']; ?>" class="w-full text-blue-500 px-3 py-1.5 rounded-md flex justify-center items-center ">
            <span class="flex  items-center h-6 px-3 text-xs font-semibold text-green-500 bg-green-100 rounded-full ">change statut</span>
         </a>
      </div>
   </div>

   <div id="hiddenSection<?php echo $todoTask['id'] ?>" class="section-anim overlay hidden w-screen h-screen fixed top-0 left-0 z-20 flex items-center ">
      <div class="p-6 rounded-lg shadow-md bg-white w-1/2 h-full">
         <div class="flex items-center w-full justify-between">
            <h2 class="text-2xl font-bold mb-4 text-center mr-auto ml-auto"><?php echo $todoTask['titre'] ?></h2>
         ...
         <div class="space-y-6">
            ...
            <div class="flex items-center space-x-6">
               ...
               <?php 
                  ...
                  $category=$categoryTaskModel->getCategoriesByTask($todoTask['id']);
