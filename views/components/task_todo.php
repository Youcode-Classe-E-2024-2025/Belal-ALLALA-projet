...
?>
<div id="task" class="task relative flex flex-col items-start p-4 mt-3 bg-white rounded-lg cursor-pointer bg-opacity-90 group hover:bg-opacity-100" draggable="true">
   ...
   <input type="hidden" name="task_id" value="<?php echo $todoTask['id'] ?>" >
...
<div id="hiddenSection<?php echo $todoTask['id'] ?>" class="section-anim overlay hidden w-screen h-screen fixed top-0 left-0 z-20 bg-black/40 flex items-center ">
   <div class="p-6 rounded-lg shadow-md bg-white w-1/2 h-full">

      <h2 class="text-2xl font-bold mb-4 text-center"><?php echo $todoTask['titre'] ?></h2>
      ...
      <div class="space-y-6">
         ...
         <div class="flex items-center space-x-6">
            ...
            <span><?php echo $todoTask['deadline'] ?></span>
         </div>
         ...
         <div class="flex items-center space-x-6">
            ...
            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800 mr-2"><?php echo $todoTask['type'] ?></span>
         </div>
         ...
         <div>
            ...
            <p class=" border p-4 rounded-lg bg-gray-50 text-start">
               <?php echo $todoTask['description'] ?>
            </p>
         </div>
         <div class="flex items-center space-x-2">
            <button class="close-btn bg-red-500 font-bold py-2 px-4 rounded-lg shadow-md hover:bg-red-600 hover:shadow-lg active:bg-red-700 active:shadow-inner transition-all duration-300 text-white">
               close
            </button>
            <button class="bg-blue-500 font-bold py-2 px-4 rounded-lg shadow-md hover:bg-blue-600 hover:shadow-lg active:bg-blue-700 active:shadow-inner transition-all duration-300 text-white">
               update
            </button>
         </div>
      </div>
